...
async def chat3(conversation_token, username, input):
    ...
    summarized_buffer = ConversationSummaryMemory(llm=llm_gpt3, return_messages=True, chat_memory=ChatMessageHistory(messages=history_util.get_base_memory(conversation_token)))
