...
async def chat3(conversation_token, username, input):
    ...
    new_history = ConversationSummaryBufferMemory(return_messages=True, chat_memory=ChatMessageHistory(messages=history), max_token_limit=ncconfig.cf.max_chat_history)
